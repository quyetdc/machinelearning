...
def affinityPropagationClustering():
    ...
    # affinityPropagationModel = AffinityPropagation(max_iter=500, damping=0.8)
    # affinityPropagationModel = MeanShift()
    affinityPropagationModel = NearestNeighbors()

    affinityPropagationModel.fit(customer_data)
    predict_labels = affinityPropagationModel.predict(customer_data)

    print('predict_labels: ')
    print(predict_labels)

    centroids = affinityPropagationModel.cluster_centers_
    print('centroids:')
    print(centroids)
